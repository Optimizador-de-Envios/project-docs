...
| [USER_STORIES.md](USER_STORIES.md) | **Historias de Usuario** — Especificación funcional del sistema desde la perspectiva del usuario. | 9 historias de usuario (HU-01 a HU-09) consolidadas entre MVP base y MVP v2, con descripción, valor de negocio, reglas relacionadas, Definition of Ready, criterios de aceptación en Gherkin, Definition of Done y tabla de estimación en Story Points. |
...
| [REALITY_CHECK.md](REALITY_CHECK.md) | **Reality Check** — Comparación entre lo estimado y lo realmente requerido por cada historia de usuario. | Valoración por HU sobre si estuvo bien estimada, ligeramente subestimada o mal estimada, con comentarios sobre complejidad real, dependencias externas, autenticación y patrones utilizados. |
